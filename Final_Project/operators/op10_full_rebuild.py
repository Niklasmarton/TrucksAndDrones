...
def _small_n_rebuild(truck_pool, loose_custs,
    ...
    tsp_route = op6._optimize_truck_route_with_tsp(skeleton, truck_times, depot)
...
def operator(current_solution):
    ...
    new_truck = op6._optimize_truck_route_with_tsp(skeleton_truck, truck_times, depot)
