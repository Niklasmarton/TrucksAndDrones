"""
op14 — double-bridge escape with biased top-k greedy drone rebuild
...
Why this replaces op9 for escape:
  op9 applied 15-20 related-node destroy/repair steps. Each step degrades
